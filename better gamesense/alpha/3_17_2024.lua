...
local __version = "Alpha 1.2"

------------------------------------------------------

__UPDATELOG = {
    "3/17/2024 - Changelog",
    "    - Added indicator selection (not force now)",
    "    - Added text watermark",
    "    - Add events sound (Not yet)",
    "    - Fixed 45 deg defensive pitch not working",
    "    - Improved defensive sideway yaw mode",
    "    - Removed FS indicator",
    "2/25/2024 - Changelog",
    "    - Added teleport key",
    "    - Added scrtipt unload function",
    "    - Now jumpscout fix not working when menu open",
    "        ",
    "2/24/2024 - Changelog",
    "    - Fixed antiaim desync inventer return out the bound",
    "    - Fixed some known issues",
    "    - Fixed defensive antiaim items visible exception",
