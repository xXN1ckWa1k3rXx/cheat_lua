...
nick.menu = {
    ...
    ["antiaim"] = {
        ...
        fakeflick = nick.ref.antiaim.angles:switch("Fake Flick (BETA)"):tooltip("Testing phase\n\nYou need to use it with Manual AA (Left and Right)\n\n\a698EFFFF" .. ui.get_icon("triangle-exclamation") .. " You need to bind it and use Hold, it is strongly recommended to bind it with Manual AA on a Key, Manual AA is not an override"):disabled(true),
...
nick.Elements = {
    ...
    ["defensive"] = {
        pitch = nick.CreateElements.antiaim.defensive:combo("Pitch", {"Default", "Zero", "Up", "Down", "Random", "Jitter", "45 deg"}),
        yaw = nick.CreateElements.antiaim.defensive:combo("Yaw", {"Default", "Static", "Random", "Side-Way", "Spin"}),
