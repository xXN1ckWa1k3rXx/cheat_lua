...
nick.indicators = function()
    ...
    if nick.Elements.indicator.left:get("DA") and nick.ref.ragebot.da:get() then
	    render.text(font, vector(24, y / 2 + 40 + (40 * offset)), color("#cccccd"), "", "DA")
        offset = offset + 1
	end
...
nick.air_exploit = function (cmd)
    ...
    if rage.exploit:get() == 1 then
        nick.ref.antiaim.fd:override((globals.tickcount % 16 == 0 and nick.menu.antiaim.air_exploit:get()) and true or nil)
    else
